...
public class Mercadinho {
    ...
    public void listaDeProdutos(){
        ...
        while(!start){
            ...
            switch(opcao){
                case 1:
                    produto = new Eletronicos("Aifone 17", 576.23);
                    carrinho.add(produto);
                    System.out.println("Colocou o "+produto.getNome()+" no carrinho!");
                    start = true;
                    break;
                case 2:
                    produto = new Eletronicos("Iphone 2", 2780.27);
                    carrinho.add(produto);
                    System.out.println("Colocou o "+produto.getNome()+" no carrinho!");
                    start = true;
                    break;
                case 3:
                    produto = new Eletronicos("Casaco de Lã", 85.50);
                    carrinho.add(produto);
                    System.out.println("Colocou o "+produto.getNome()+" no carrinho!");
                    start = true;
                    break;
                case 4:
                    produto = new Eletronicos("Vazio de Tamanduá", 231.99);
                    carrinho.add(produto);
                    System.out.println("Colocou o "+produto.getNome()+" no carrinho!");
                    start = true;
                    break;
